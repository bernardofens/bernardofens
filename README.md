...
```swift
struct Bernardo: Developer {
    let name       = "Bernardo Fensterseifer"
    let location   = "Porto Alegre, RS 🇧🇷"
    let university = "PUCRS — Computer Science"
...
| 🎓 Studying | 💼 Working On | 🌱 Learning |
|:---:|:---:|:---:|
| Computer Science @ PUCRS | iOS Apps @ Apple Dev Academy | SwiftUI & Combine |
| Algorithms & Data Structures | Real-world Apple projects | Xcode Cloud & CI/CD |
...
![Snake animation](https://raw.githubusercontent.com/bernardofens/bernardofens/output/github-contribution-grid-snake-dark.svg)
